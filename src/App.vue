    ...
    <div class="main">
      <v-app-bar dense app>
        ...
        <v-text-field v-if="showSearch" label="Search">
          <v-icon slot="append" color="red" v-on:click="toggleSearch">
            mdi-close
          </v-icon>
        </v-text-field>
        ...
        <v-btn icon v-on:click="toggleSearch" v-if="!showSearch">
          <v-icon>mdi-magnify</v-icon>
        </v-btn>

        <v-btn v-on:click="log(getCartCount)" icon v-if="!showSearch">
          <v-badge overlap :content="getCartCount" :value="getCartCount">
